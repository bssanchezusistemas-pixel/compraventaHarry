...
/**
 * Iconos SVG (trazos estilo Lucide) para reemplazar emojis estructurales.
 * Heredan color vía `currentColor` y tamaño vía CSS del contenedor.
 */
...
export function IconGem(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base(props)}>
